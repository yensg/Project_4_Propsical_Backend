...
def create_listing():
    ...
    try:
        ...
        cursor.execute('INSERT INTO listings ('
                       'asking_price, floor_size, land_size, bedroom, toilet, type, unit_number, location, geo_lat, geo_lon, summary, description, account_id) VALUES ('
                       '%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);',
                       (data['asking_price'], data['floor_size'], data['land_size'], data['bedroom'], data['toilet'], data['type'], data['unit_number'], data['location'], data['geo_lat'], data['geo_lon'], data['summary'], data['description'], data['account_id']))
        conn.commit()
